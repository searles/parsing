...
//    }
//
//    class MyState(val listSize: Int, stream: TokenStream): TokenStream.State(stream)
//
//    inner class MyTokenStream(src: String): TokenStream(src) {
...
//            override fun onSelect(source: TokenStream, label: Any, startState: TokenStream.State) {}
//            override fun onMark(source: TokenStream, label: Any) {}
//        }
//
...
//            override fun onMark(source: TokenStream, label: Any) {
//                if(label == "newLine") {
//                    edits.add(Insert(source.startIndex, "\n"))
//                }
//            }
//        }
//
...
//            override fun onSelect(source: TokenStream, label: Any, startState: TokenStream.State) {
//                if(label == "num") {
//                    val length = source.startIndex - startState.index
